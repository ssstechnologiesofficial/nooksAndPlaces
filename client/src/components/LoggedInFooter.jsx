...
const policies = {
  'refund-policy': (
    <div>
      ...
      <p>
        <strong>
          TERRAFORMA LLP follows the below-mentioned cancellation policy. Under
          this policy:
        </strong>
      </p>
      <ul className="list-disc pl-5 space-y-2">
        <li>
          ...
          <strong>24 hours</strong> of placing the order. However, the request
          may not be entertained if the orders have been communicated to
          vendors/merchants and they have initiated shipping.
        </li>
        <li>
          <strong>Perishable items</strong> like flowers and eatables cannot be
          canceled.
        </li>
        <li>
          If you receive <strong>damaged or defective items</strong>, report it
          to Customer Service within <strong>2 days</strong>. The merchant will
          verify the claim before processing.
        </li>
        <li>
          If the product does not match the description or your expectations,
          notify Customer Service within <strong>2 days</strong>. The team will
          take appropriate action.
        </li>
        <li>
          For products under <strong>warranty</strong>, please contact the
          manufacturer.
        </li>
        <li>
          Approved refunds will be processed within <strong>6-8 days</strong> to
          the end customer.
        </li>
      </ul>
    </div>
  ...
  'shipping-policy': (
    <div>
      ...
      <p>
        ...
        15-21 days or as per the delivery date agreed at the time of order
        confirmation and delivering of the shipment subject to Courier Company /
        post office norms. TERRAFORMA LLP is not liable for any delay in
        delivery by the courier company / postal authorities and only guarantees
        to hand over the consignment to the courier company or postal
        authorities within 15-21 days rom the date of the order and payment or
        ...
        contact our helpdesk on 9910446561 or orders-homes@fsix.in
      </p>
    </div>
  ),
  'privacy-policy': (
    <div>
      ...
      <p>
        ...
        such as Shopify. Our payment processors, who collect payment information
        (e.g., bank account, credit or debit card information, billing address)
        to process your payment in order to fulfill your orders and provide you
        with products or services you have requested, in order to perform our
        contract with you. When you visit our Site, open or click on emails we
        send you, or interact with our Services or advertisements, we, or third
        parties we work with, may automatically collect certain information
        using online tracking technologies such as pixels, web beacons, software
        developer kits, third-party libraries, and cookies. Any information we
        obtain from third parties will be treated in accordance with this
        Privacy Policy. We are not responsible or liable for the accuracy of the
        information provided to us by third parties and are not responsible for
        any third party's policies or practices. For more information, see the
        section below, Third Party Websites and Links. How We Use Your Personal
        Information Providing Products and Services. We use your personal
        ...
        your personal information to better tailor the Services and advertising
        on our Site and other websites. Security and Fraud Prevention. We use
        your personal information to detect, investigate or take action
        ...
        contact us immediately. Communicating with you. We use your personal
        ...
        business relationship with you. Cookies Like many websites, we use
        Cookies on our Site. For specific information about the Cookies that we
        ...
        Such circumstances may include: With vendors or other third parties who
        perform services on our behalf (e.g., IT management, payment processing,
        data analytics, customer support, cloud storage, fulfillment and
        shipping). With business and marketing partners, including Shopify, to
        ...
        Services, our rights, and the rights of our users or others. We do not
        use or disclose sensitive personal information for the purposes of
        inferring characteristics about you. User Generated Content The Services
        may enable you to post product reviews and other user-generated content.
        If you choose to submit user generated content to any public area of the
        Services, this content will be public and accessible by anyone. We do
        not control who will have access to the information that you choose to
        make available to others, and cannot ensure that parties who have access
        to such information will respect your privacy or keep it secure. We are
        not responsible for the privacy or security of any information that you
        make publicly available, or for the accuracy, use or misuse of any
        information that you disclose or receive from third parties. Third Party
        Websites and Links Our Site may provide links to websites or other
        online platforms operated by third parties. If you follow links to sites
        not affiliated or controlled by us, you should review their privacy and
        security policies and other terms and conditions. We do not guarantee
        and are not responsible for the privacy or security of such sites,
        ...
        venues, including information you share on third-party social networking
        ...
        owners or operators, except as disclosed on the Services. Children’s
        Data The Services are not intended to be used by children, and we do not
        ...
        information of individuals under 16 years of age. Security and Retention
        of Your Information Please be aware that no security measures are
        ...
        certain cases, we may decline your request as permitted by law. Right to
        Access / Know. You may have a right to request access to personal
        ...
        exceptions. Restriction of Processing: You may have the right to ask us
        to stop or restrict our processing of personal information. Withdrawal
        of Consent: Where we rely on consent to process your personal
        ...
        your request. You can do so by replying directly to our denial. Managing
        Communication Preferences: We may send you promotional emails, and you
        may opt out of receiving these at any time by using the unsubscribe
        option displayed in our emails to you. If you opt out, we may still send
        you non-promotional emails, such as those about your account or orders
        that you have made. You may exercise any of these rights where indicated
        on our Site or by contacting us using the contact details provided
        below. We will not discriminate against you for exercising any of these
        ...
        applicable laws, You may designate an authorized agent to make requests
        on your behalf to exercise your rights. Before accepting such a request
        ...
        timely manner as required under applicable law. Complaints If you have
        complaints about how we process your personal information, please
        contact us using the contact details provided below. If you are not
        satisfied with our response to your complaint, depending on where you
        live you may have the right to appeal our decision by contacting us
        using the contact details set out below, or lodge your complaint with
        your local data protection authority. International Users Please note
        ...
        personal information is also processed by staff and third party service
        providers and partners in these countries. If we transfer your personal
        information out of Europe, we will rely on recognized transfer
        mechanisms like the European Commission's Standard Contractual Clauses,
        or any equivalent contracts issued by the relevant competent authority
        of the UK, as relevant, unless the data transfer is to a country that
        has been determined to provide an adequate level of protection. Contact
        ...
        available to you, please call +91 9811058378 / 9910446561 or email us at
        orders-homes@fsix.in
      </p>
    </div>
  ),
  'terms-of-service': (
    <div>
      ...
      <p className="mb-4">
        OVERVIEW This website is operated by F SIX HOMES. Throughout the site,
        the terms “we”, “us” and “our” refer to F SIX HOMES. F SIX HOMES offers
      ...
      <p className="mb-4">
        SECTION 1 - ONLINE <br />
        STORE TERMS By agreeing to these Terms of Service, you represent that
        ...
        minor dependents to use this site. You may not use our products for any
        ...
        copyright laws). You must not transmit any worms or viruses or any code
      ...
      <p className="mb-4">
      SECTION 2 - GENERAL CONDITIONS <br /> We reserve the right to refuse Service to
      ...
      <p className="mb-4">SECTION 3 - ACCURACY, COMPLETENESS AND
      TIMELINESS OF INFORMATION <br />We are not responsible if information made
      available on this site is not accurate, complete or current. The material
      on this site is provided for general information only and should not be
      ...
      site.</p> <p className="mb-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES <br /> Prices for our
      products are subject to change without notice. We reserve the right at any
      ...
      discontinuance of the Service.</p> <p className="mb-4"> SECTION 5 - PRODUCTS OR SERVICES (if
      applicable) <br /> Certain products or Services may be available exclusively
      ...
      that appear at the store. We cannot guarantee that your computer monitor's
      ...
      corrected.</p> <p className="mb-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION <br />We
      ...
      complete your transactions and contact you as needed. For more details,
      please review our Refund Policy: [LINK TO REFUND POLICY]</p> <p className="mb-4"> SECTION 7 -
      OPTIONAL TOOLS <br />We may provide you with access to third-party tools over
      which we neither monitor nor have any control nor input. You acknowledge
      and agree that we provide access to such tools ”as is” and “as available”
      ...
      from or relating to your use of optional third-party tools. Any use by you
      of the optional tools offered through the site is entirely at your own
      ...
      and resources). Such new features and/or Services shall also be subject to
      these Terms of Service.</p> <p className="mb-4"> SECTION 8 - THIRD-PARTY LINKS <br />Certain content,
      ...
      or Services of third-parties. <br />We are not liable for any harm or damages
      ...
      directed to the third-party.</p> <p className="mb-4"> SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER
      SUBMISSIONS <br /> If, at our request, you send certain specific submissions (for
      ...
      or any third-party.</p> <p className="mb-4">SECTION 10 - PERSONAL INFORMATION <br />Your submission of
      personal information through the store is governed by our Privacy Policy,
      which can be viewed here: [LINK TO PRIVACY POLICY]</p> <p className="mb-4"> SECTION 11 - ERRORS,
      INACCURACIES AND OMISSIONS <br />Occasionally there may be information on our
      site or in the Service that contains typographical errors, inaccuracies or
      omissions that may relate to product descriptions, pricing, promotions,
      offers, product shipping charges, transit times and availability. We
      ...
      except as required by law. No specified update or refresh date applied in
      the Service or on any related website, should be taken to indicate that
      all information in the Service or on any related website has been modified
      or updated.</p> <p className="mb-4"> SECTION 12 - PROHIBITED USES <br />In addition to other prohibitions
      ...
      any of the prohibited uses.</p> <p className="mb-4">  SECTION 13 - DISCLAIMER OF WARRANTIES;
      LIMITATION OF LIABILITY <br />We do not guarantee, represent or warrant that
      your use of our Service will be uninterrupted, timely, secure or
      error-free. <br /> We do not warrant that the results that may be obtained from
      the use of the Service will be accurate or reliable. <br />You agree that from
      time to time we may remove the Service for indefinite periods of time or
      cancel the Service at any time, without notice to you. <br /> You expressly agree
      ...
      for a particular purpose, durability, title, and non-infringement. <br /> In no
      case shall F SIX HOMES, our directors, officers, employees, affiliates,
      ...
      to the maximum extent permitted by law.</p> <p className="mb-4"> SECTION 14 - INDEMNIFICATION <br /> You
      agree to indemnify, defend and hold harmless F SIX HOMES and our parent,
      ...
      by reference, or your violation of any law or the rights of a third-party.</p> <p className="mb-4">
      SECTION 15 - SEVERABILITY <br /> In the event that any provision of these Terms
      ...
      the validity and enforceability of any other remaining provisions.</p> <p className="mb-4"> SECTION
      16 - TERMINATION <br />The obligations and liabilities of the parties incurred
      ...
      you access to our Services (or any part thereof).</p> <p className="mb-4"> SECTION 17 - ENTIRE
      AGREEMENT <br />
      ...
      entire agreement and understanding between you and us and governs your use
      ...
      shall not be construed against the drafting party.</p> <p className="mb-4"> SECTION 18 - GOVERNING
      LAW <br />These Terms of Service and any separate agreements whereby we provide
      you Services shall be governed by and construed in accordance with the
      laws of India.</p> <p className="mb-4"> SECTION 19 - CHANGES TO TERMS OF SERVICE <br />You can review the
      most current version of the Terms of Service at any time at this page. We
      ...
      acceptance of those changes.</p> <p className="mb-4"> SECTION 20 - CONTACT INFORMATION <br />Questions
      about the Terms of Service should be sent to us at imaan@fsix.in. Our
      contact information is posted below: <br />[INSERT TRADING NAME] <br />imaan@fsix.in
      [INSERT BUSINESS ADDRESS] <br /> [INSERT BUSINESS PHONE NUMBER]br [INSERT BUSINESS
      REGISTRATION NUMBER] <br />[INSERT VAT NUMBER]</p>
    </div>
  ),
};
...
const LoggedInFooter = () => {
  ...
  const openModal = (policyKey) => {
    setModalContent(policies[policyKey]);
    setModalOpen(true);
  };
    ...
    <>
      <footer className="bg-gray-100 py-6 text-center">
        <div className="flex justify-center gap-6 text-gray-700 text-sm">
          ...
          <button
            onClick={() => openModal('shipping-policy')}
            className="hover:text-blue-600"
          >
            Shipping Policy
          </button>
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-2xl relative">
            ...
            <div className="max-h-60 overflow-y-auto p-2 text-gray-700">
              {modalContent}
            </div>
          </div>
        </div>
